...
- [ ] **Phase 23 (ACTUAL):** Frontend — Flujo Forense Unificado (Enrollment + Search + Minucias) — Plan 01 (match_trace backend) ✅, Plan 02 (SOCOFing seed + cleanup) ✅, Plan 03 (API client rewrite) ✅
